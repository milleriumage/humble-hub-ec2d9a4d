...
export class Client extends EventEmitter {
	...
	protected readonly store: Store | undefined;
	...
	public constructor() {
		...
		// Use an in-memory cookie store for browser compatibility
		this.cookies = new CookieJar(undefined, { rejectPublicSuffixes: false });
		this.http = wrapper(
			axios.create({
