...
export class Utilities {
	...
	public async resource<T extends Resource<any>>(
        ...
        // FIX: Cast resource to any to satisfy the return type, avoiding the Writable<T> vs T conflict.
		return cls ? this.deserialize(cls, resource as APIResource<T>) : (resource as any);
	}
